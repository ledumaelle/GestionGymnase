 ...
 * @author Rabelais
 */
public class FXMLModifierReservationController implements Initializable
{
    
    // FAIRE COMME SUPPRIMER UNE RESERVATION 
    ...
    {
        ObservableList<Reservation> lesReservations =  GestionReservationBdD.getReservation();
        cmbReservation.setItems(lesReservations);         
    }    
    ...
    public void handleSelectionReservation()
    {
        cmbAssociation.setItems(null);
        cmbSalle.setItems(null);
        cmbSport.setItems(null);
        tabReservation.setItems(null);
        Reservation UneReservation = (Reservation)(cmbReservation.getSelectionModel().getSelectedItem());
        ObservableList<Association> lesAssociations =  GestionAssociationBdD.getAssociation();
        cmbAssociation.setItems(lesAssociations);
        cmbAssociation.getSelectionModel().select(GestionReservationBdD.getReservationAssociation(UneReservation));
    }
